...
@section('content')
        ...
        <div class="m-portlet">
            <div class="m-portlet__head">
                ...
                <div class="m-portlet__head-tools">
                    <a href="{{route('setting-module.create')}}" class="btn btn-success m-btn m-btn--custom m-btn--icon">
                        <span>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> {{__('Xóa Module')}} </h5>
    ...
    jQuery(document).ready(function (){
        datatable = $('#table_main').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('setting-module.index') !!}',
                columns: [
                    { data: 'id', name: 'id' },
